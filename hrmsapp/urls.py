...
urlpatterns = [
    ...
    path('admin_iga/exporter_autorisations', views.exporter_autorisations, name='exporter_autorisations'),
    ...
    path('refuser_autorisation/<str:pk>/', views.refuser_autorisation, name='refuser_autorisation'),
]